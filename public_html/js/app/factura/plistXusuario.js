...
//        $http({
//            method: 'GET',
//            url: 'http://localhost:8081/trolleyes/json?ob=' + $scope.ob + '&op=getcountXusu&id='+$scope.id_usuario
//        }).then(function (response) {
//            $scope.status = response.status;
...
//        $http({
//            method: 'GET',
//            url: 'http://localhost:8081/trolleyes/json?ob=' + $scope.ob +'&op=getpageXusu&id='+$scope.id_usuario+  '&rpp=' + $scope.rpp + '&page=' + $scope.page + $scope.orderURLServidor
//        }).then(function (response) {
//            $scope.status = response.status;
//            $scope.ajaxDataUsuarios = response.data.message;
//        }, function (response) {
